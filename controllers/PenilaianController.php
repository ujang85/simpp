...
class PenilaianController extends Controller
{
    ...
    public function actionIndexsetting()
    {    
        $searchModel = new PenilaianSearch();
        $dataProvider = $searchModel->search(Yii::$app->request->queryParams);

        return $this->render('indexsetting', [
            'searchModel' => $searchModel,
            'dataProvider' => $dataProvider,
        ]);
    }
        ...
        if($request->isAjax){
            ...
            */
            if ($model->load($request->post()) && $model->save()) {
                ...
                return $this->render('updatesetting', [
                    'model' => $model,
                ]);
            }
        }
    ...
    public function actionGetNip($penilaiId)
    {   
        $nip=NominatifPegawai::find()->where(['id'=>$penilaiId])->one();
        echo Json::encode($nip);
        exit;
    }
    /**
